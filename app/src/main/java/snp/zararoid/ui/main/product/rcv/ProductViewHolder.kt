...
class ProductViewHolder(itemView: View):RecyclerView.ViewHolder(itemView) {
    ...
    private val imageUrl: ImageView = itemView.findViewById(R.id.img_product)
    ...
    fun onBind(data: ProductData){
        ...
        Glide.with(itemView).load(data.imageUrl).placeholder(R.drawable.loading).error(R.drawable.loading).into(imageUrl)
    }
}